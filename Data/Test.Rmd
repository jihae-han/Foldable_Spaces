...
#---Fix input errors from participant----#
#reversed the order of like to dislike (top/bottom)
ranking[which(ranking$ID==3),]$Rank <- c("Fourth","Third","Second","First")
#switched vertical and S&R
ranking[which(ranking$ID==7),]$Rank <- c("Third","Second","First","Fourth")
